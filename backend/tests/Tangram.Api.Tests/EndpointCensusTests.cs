    ...
    : IClassFixture<TangramWebApplicationFactory>, IAsyncLifetime
{
    ...
    private static readonly Dictionary<string, int> Budgets = new()
    {
        ...
        ["POST /boards/{id}/columns"] = 6,
        ["POST /boards/{id}/columns/bulk"] = 7,
        ["PATCH /columns/{id}"] = 6,
        ["PATCH /columns/{id}/limits"] = 6,
        ["POST /columns/{id}/move"] = 6,
        ["POST /columns/{id}/cards"] = 6,
        ["PATCH /cards/{id}"] = 7,
        ["POST /cards/{id}/move"] = 7,
        ["DELETE /cards/{id}"] = 6,
        ["POST /boards/{id}/labels"] = 7,
        ["PATCH /labels/{id}"] = 7,
        ["GET /cards/{id}/comments"] = 3,
        ["POST /cards/{id}/comments"] = 7,
        ["PATCH /comments/{id}"] = 7,
